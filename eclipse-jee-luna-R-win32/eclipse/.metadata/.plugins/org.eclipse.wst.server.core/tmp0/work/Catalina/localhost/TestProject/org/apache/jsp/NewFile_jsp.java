 ...
 * Generated at: 2014-10-24 15:09:17 UTC
...
public final class NewFile_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>Big-Sensor-Cloud Infrastructure home_page</title>\r\n");
      ...
      out.write("\t</div>\r\n");
      out.write("<marquee scrollamount=\"3\"><b><font size = \"4\" color = \"red\" face=\"Lucida\"><i>Big-Sensor-Cloud: A paradigm shift from traditional Wireless Sensor Networks</i></font></b></marquee>ï»¿\r\n");
      ...
      out.write("\t\t\t\t\t<p><strong> Big-Sensor-Cloud Infrastructure </strong> is a unique sensor data storage, visualization and remote management platform that leverages powerful cloud computing\r\n");
      out.write("\t\t\t\t\ttechnologies to provide excellent data scalability, rapid visualization, and user programmable analysis. </p>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<p> The idea of sensor-cloud thrives on the principle of virtualization of physical sensor nodes. The sensor-cloud architecture\r\n");
      out.write("\t\t\t\t\tis positioned as an intermediate stratum of processing between the physical sensor nodes and the end-user-organization. The\r\n");
      out.write("\t\t\t\t\tuser-organizations possess their own applications, and request the sensor-cloud for retrieval of sensed data. These requests are interpreted within the sensor-cloud environment and the\r\n");
      out.write("\t\t\t\t\tphysical sensor nodes are dynamically consorted to form virtual sensor groups, as per requirements. Data from the wireless physical sensor nodes reach the sensor-cloud through\r\n");
      out.write("\t\t\t\t\tstandard wireless multi-hop communication. On behalf of each virtual group, the aggregated data is transmitted to the enduser organization. The data obtained is then delivered to the\r\n");
      out.write("\t\t\t\t\tapplication, followed by subsequent processing and analysis on part of the end-users. </p>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t<p> The current state-of-the-art generally does not allow the users to access WSN-based applications without owning the sensor nodes, and deploying the same. Our work significantly\r\n");
      out.write("\t\t\t\t\tcontributes towards dissemination of the access of such applications to multiple persons/organizations. For this purpose, the work focuses on a theoretical\r\n");
      out.write("\t\t\t\t\tmodeling of virtualization of physical sensor nodes.In contrast to traditional WSN-based technology, sensorcloud remarkably improves on the pricing scheme.\r\n");
      out.write("\t\t\t\t\tSensor-cloud enables a user-organization to scale (up/down) its demands, and pay only for the service it seeks/receives. The user-organization is relieved from the\r\n");
      out.write("\t\t\t\t\tdeployment, and maintenance overheads associated with a typical WSN. This work illustrates the flow of revenue for each of the actors associated with the sensor-cloud\r\n");
      out.write("\t\t\t\t\tarchitecture.</p> \r\n");
      out.write("\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t\r\n");
